...
const MyThesis = () => {
    ...
    return (
      <div style={{ textAlign: "center", padding: "100px 0" }}>
        ...
        <div style={{ marginTop: 16 }}>
          <Text>Đang tải thông tin luận văn...</Text>
        </div>
      </div>
    );
  }
  ...
  if (myTheses.length === 0) {
    return (
      <Result
        status="info"
        title="Bạn chưa đăng ký đề tài luận văn"
  ...
  return (
    <div style={{ maxWidth: 800, margin: "0 auto" }}>
      <Card
        title={
          <Title level={4}>
            <FileTextOutlined /> Luận văn của tôi
          </Title>
        }
      >
        {myTheses.length > 1 ? (
          ...
          <Empty description="Không tìm thấy thông tin luận văn" />
        )}
      </Card>
    </div>
  );
